...
SELECT stuNumber, stuName, sex, college, major, class, address, telNumber, birthday FROM stuInfor WHERE (stuNumber = @stuNumber)";
        ...
        public virtual int Update(
                    ...
                    string Original_telNumber, 
                    string Original_birthday) {
            return this.Update(Original_stuNumber, stuName, sex, college, major, _class, address, telNumber, birthday, Original_stuNumber, Original_stuName, Original_sex, Original_college, Original_major, Original_class, Original_address, Original_telNumber, Original_birthday);
        }
    }
}
